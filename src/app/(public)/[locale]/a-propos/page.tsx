...
const CONTENT: Record<Locale, Content> = {
  fr: {
    ...
    sections: [
      {
        heading: "Pourquoi Vitrectomed a été créé ?",
        text:
          "Vitrectomed est né d’un constat simple : après une vitrectomie avec injection de gaz, le respect strict de la position post‑opératoire est essentiel pour créer de bonnes conditions de récupération.\n\n" +
          ...
          "L’objectif de Vitrectomed est d’apporter un soutien pratique pendant cette période, en proposant un dispositif dédié au maintien de la posture recommandée par le chirurgien.",
      },
      {
        heading: "À quoi sert Vitrectomed pendant la convalescence ?",
        text:
          "Vitrectomed aide le patient à adopter et à maintenir plus facilement la posture indiquée par le chirurgien après l’intervention.\n\n" +
      ...
      },
      {
        ...
        text:
          "Vitrectomed a été pensé pour offrir un maintien stable, de jour comme de nuit, tout en restant simple à installer et à ajuster.\n\n" +
      ...
      {
        heading: "Pour qui Vitrectomed est‑il destiné ?",
        text:
          "Vitrectomed est destiné aux patients opérés d’une vitrectomie avec injection de gaz, lorsque le chirurgien prescrit une position post‑opératoire spécifique.\n\n" +
      ...
      },
      {
        ...
        text:
          "Vitrectomed ne remplace pas un avis médical, un examen clinique ni un suivi spécialisé.\n\n" +
          ...
          "Avant d’utiliser Vitrectomed, et en cas de douleur inhabituelle, d’inconfort important ou de question sur votre récupération, il est essentiel de consulter votre médecin.",
      },
    ],
    faq: [
      {
        q: "Vitrectomed remplace‑t‑il un dispositif médical prescrit par le chirurgien ?",
        a: "Non. Vitrectomed est un dispositif d’accompagnement. Il ne remplace ni les équipements spécifiques éventuellement prescrits, ni les recommandations de votre chirurgien. Toute décision concernant votre traitement ou votre position doit rester médicale.",
      },
      {
        q: "Puis‑je utiliser Vitrectomed sans avis médical préalable ?",
  ...
  en: {
    ...
    sections: [
      {
        heading: "Why was Vitrectomed created?",
        text:
          "Vitrectomed was created from a simple observation: after vitrectomy with gas injection, strictly maintaining the post‑operative position is essential to support proper healing conditions.\n\n" +
          ...
          "Vitrectomed aims to provide practical support during this period by offering a dedicated device to help maintain the position recommended by the surgeon.",
      },
      {
        heading: "How does Vitrectomed help during recovery?",
        text:
          "Vitrectomed helps patients adopt and maintain the posture indicated by their surgeon after the procedure.\n\n" +
      ...
      },
      {
        ...
        text:
          "Vitrectomed is designed to provide stable support, day and night, while remaining easy to set up and adjust.\n\n" +
      ...
      {
        heading: "Who is Vitrectomed for?",
        text:
          "Vitrectomed is intended for patients who have undergone vitrectomy with gas injection when a specific post‑operative position is prescribed by their surgeon.\n\n" +
          ...
          "If you are unsure whether Vitrectomed is appropriate in your situation, you should discuss it with your ophthalmologist or another healthcare professional.",
      },
      {
        heading: "Important – the role of your medical team",
        text:
          "Vitrectomed does not replace medical advice, clinical examination or specialized follow‑up.\n\n" +
          ...
          "Before using Vitrectomed, and in case of unusual pain, significant discomfort or any concern about your recovery, you should contact a doctor.",
      },
    ],
    faq: [
      {
        q: "Does Vitrectomed replace a medical device prescribed by the surgeon?",
        a: "No. Vitrectomed is a support device. It does not replace specific equipment or recommendations prescribed by your surgeon. All treatment decisions, including positioning, must remain medical.",
      },
      {
        q: "Can I use Vitrectomed without talking to my doctor?",
  ...
  es: {
    ...
    sections: [
      {
        heading: "¿Por qué se creó Vitrectomed?",
        text:
          "Vitrectomed nació de una observación sencilla: tras una vitrectomía con inyección de gas, respetar estrictamente la postura posoperatoria es esencial para favorecer buenas condiciones de recuperación.\n\n" +
          ...
          "Vitrectomed tiene como objetivo aportar un apoyo práctico durante este periodo mediante un dispositivo dedicado a facilitar el mantenimiento de la postura recomendada por el cirujano.",
      },
      {
        heading: "¿Cómo ayuda Vitrectomed durante la recuperación?",
        text:
          "Vitrectomed ayuda al paciente a adoptar y mantener más fácilmente la postura indicada por el cirujano tras la intervención.\n\n" +
      ...
      },
      {
        ...
        text:
          "Vitrectomed está diseñado para ofrecer un apoyo estable, tanto de día como de noche, y seguir siendo fácil de colocar y ajustar.\n\n" +
      ...
      {
        heading: "¿Para quién está indicado Vitrectomed?",
        text:
          "Vitrectomed está destinado a pacientes operados de vitrectomía con inyección de gas cuando el cirujano prescribe una postura posoperatoria específica.\n\n" +
      ...
      },
      {
        ...
        text:
          "Vitrectomed no sustituye el consejo médico, la exploración clínica ni el seguimiento especializado.\n\n" +
          ...
          "Antes de utilizar Vitrectomed, y ante cualquier dolor inusual, molestia importante o duda sobre la recuperación, es esencial consultar al médico.",
      },
    ],
    faq: [
      {
        q: "¿Sustituye Vitrectomed a un dispositivo médico prescrito por el cirujano?",
        a: "No. Vitrectomed es un dispositivo de apoyo. No sustituye a los equipos específicos ni a las recomendaciones indicadas por el cirujano. Todas las decisiones relativas a su tratamiento deben seguir siendo médicas.",
      },
      {
        q: "¿Puedo usar Vitrectomed sin comentarlo con mi médico?",
  ...
  de: {
    title: "Über Vitrectomed",
    subtitle:
      "Medizinisches Hilfsmittel zur Unterstützung der Erholung nach Vitrektomie mit Gasinjektion.",
    lead:
      "Vitrectomed wurde mit Unterstützung von medizinischen Fachkräften entwickelt, um Patientinnen und Patienten nach einer Vitrektomie dabei zu helfen, die verordnete postoperative Lagerung besser einzuhalten und den Alltagskomfort zu verbessern. Das Produkt ersetzt keine ärztliche Beratung und muss immer gemäß den Empfehlungen des Behandlungsteams verwendet werden.",
    highlights: [
    ...
    sections: [
      {
        heading: "Warum wurde Vitrectomed entwickelt?",
        text:
          "Vitrectomed entstand aus einer einfachen Beobachtung: Nach einer Vitrektomie mit Gasinjektion ist die konsequente Einhaltung der verordneten Lagerung wichtig, um gute Voraussetzungen für die Heilung zu schaffen.\n\n" +
          ...
          "Vitrectomed soll in dieser Phase eine praktische Unterstützung bieten, indem es ein Hilfsmittel zur Verfügung stellt, das speziell für die postoperative Lagerung entwickelt wurde.",
      },
      {
        heading: "Wie unterstützt Vitrectomed in der Erholungsphase?",
        text:
          "Vitrectomed hilft, die vom Operateur empfohlene Position nach der Operation leichter einzunehmen und zu halten.\n\n" +
      ...
      },
      {
        ...
        text:
          "Vitrectomed ist auf stabilen Halt ausgelegt – tagsüber und nachts – und gleichzeitig einfach zu positionieren und anzupassen.\n\n" +
      ...
      {
        heading: "Für wen ist Vitrectomed gedacht?",
        text:
          "Vitrectomed richtet sich an Patientinnen und Patienten nach einer Vitrektomie mit Gasinjektion, wenn eine spezielle postoperative Position verordnet wurde.\n\n" +
      ...
      },
      {
        ...
        text:
          "Vitrectomed ersetzt keine ärztliche Beratung, keine klinische Untersuchung und keinen spezialisierten Verlauf.\n\n" +
          ...
          "Vor der Anwendung von Vitrectomed – und bei ungewöhnlichen Schmerzen, starkem Unbehagen oder Unsicherheit hinsichtlich des Heilungsverlaufs – sollte unbedingt ärztlicher Rat eingeholt werden.",
      },
    ],
    faq: [
      {
        q: "Ersetzt Vitrectomed ein vom Operateur verordnetes Medizinprodukt?",
        a: "Nein. Vitrectomed ist ein begleitendes Hilfsmittel und ersetzt weder spezifische medizinische Produkte noch individuelle ärztliche Empfehlungen. Entscheidungen zur Behandlung und Lagerung bleiben immer medizinische Entscheidungen.",
      },
      {
        q: "Kann ich Vitrectomed ohne Rücksprache mit meiner Ärztin/meinem Arzt verwenden?",
        a: "Es wird dringend empfohlen, die Anwendung vorab mit der Augenärztin/dem Augenarzt oder dem medizinischen Team zu besprechen, um sicherzustellen, dass Vitrectomed für Ihre Situation geeignet ist.",
      },
      {
  ...
  it: {
    ...
    sections: [
      {
        heading: "Perché è stato creato Vitrectomed?",
        text:
          "Vitrectomed nasce da una constatazione semplice: dopo una vitrectomia con iniezione di gas, il rispetto rigoroso della posizione post‑operatoria è fondamentale per favorire buone condizioni di recupero.\n\n" +
          ...
          "L’obiettivo di Vitrectomed è fornire un supporto pratico in questa fase, attraverso un dispositivo dedicato al mantenimento della postura raccomandata dal chirurgo.",
      },
      {
        heading: "Come aiuta Vitrectomed durante la convalescenza?",
        text:
          "Vitrectomed aiuta il paziente ad adottare e mantenere più facilmente la postura indicata dal chirurgo dopo l’intervento.\n\n" +
      ...
      },
      {
        ...
        text:
          "Vitrectomed è pensato per offrire un supporto stabile, giorno e notte, rimanendo semplice da posizionare e regolare.\n\n" +
      ...
      {
        heading: "A chi è destinato Vitrectomed?",
        text:
          "Vitrectomed è destinato ai pazienti sottoposti a vitrectomia con iniezione di gas quando il chirurgo prescrive una specifica posizione post‑operatoria.\n\n" +
      ...
      },
      {
        ...
        text:
          "Vitrectomed non sostituisce il parere medico, la visita clinica o il follow‑up specialistico.\n\n" +
          ...
          "Prima di utilizzare Vitrectomed, e in presenza di dolore insolito, forte disagio o qualsiasi dubbio sull’andamento della convalescenza, è essenziale consultare il medico.",
      },
    ],
    faq: [
      {
        q: "Vitrectomed sostituisce un dispositivo medico prescritto dal chirurgo?",
        a: "No. Vitrectomed è un dispositivo di supporto. Non sostituisce gli eventuali dispositivi specifici né le indicazioni terapeutiche del chirurgo. Le decisioni sul trattamento devono rimanere mediche.",
      },
      {
        q: "Posso usare Vitrectomed senza consultare prima il medico?",
  ...
  nl: {
    ...
    sections: [
      {
        heading: "Waarom is Vitrectomed ontwikkeld?",
        text:
          "Vitrectomed is ontstaan vanuit een eenvoudige vaststelling: na een vitrectomie met gasinjectie is het strikt aanhouden van de postoperatieve houding belangrijk om goede omstandigheden voor herstel te creëren.\n\n" +
          ...
          "Vitrectomed wil in deze periode praktische ondersteuning bieden met een hulpmiddel dat specifiek is ontworpen om de door de chirurg aanbevolen houding aan te houden.",
      },
      {
        heading: "Hoe helpt Vitrectomed tijdens het herstel?",
        text:
          "Vitrectomed helpt patiënten de voorgeschreven houding na de ingreep makkelijker aan te nemen en vast te houden.\n\n" +
      ...
      },
      {
        ...
        text:
          "Vitrectomed is ontworpen voor stabiele ondersteuning, overdag en ’s nachts, en is eenvoudig te plaatsen en aan te passen.\n\n" +
      ...
      {
        heading: "Voor wie is Vitrectomed bedoeld?",
        text:
          "Vitrectomed is bedoeld voor patiënten die een vitrectomie met gasinjectie hebben ondergaan en van wie de chirurg een specifieke postoperatieve houding heeft voorgeschreven.\n\n" +
          ...
          "Bij twijfel of Vitrectomed in uw geval geschikt is, is het belangrijk dit met uw oogarts of een andere zorgverlener te bespreken.",
      },
      {
        heading: "Belangrijk – de rol van uw arts",
        text:
          "Vitrectomed vervangt geen medisch advies, geen lichamelijk onderzoek en geen specialistische follow‑up.\n\n" +
          ...
          "Bij gebruik van Vitrectomed – en bij ongewone pijn, duidelijk ongemak of twijfel over uw herstel – moet u altijd een arts raadplegen.",
      },
    ],
    faq: [
      {
        q: "Vervangt Vitrectomed een medisch hulpmiddel dat door de chirurg is voorgeschreven?",
        a: "Nee. Vitrectomed is een ondersteunend hulpmiddel. Het vervangt geen specifieke medische hulpmiddelen of persoonlijke aanbevelingen van uw arts. Beslissingen over behandeling en houding blijven altijd medisch.",
      },
      {
        q: "Kan ik Vitrectomed gebruiken zonder overleg met mijn arts?",
  ...
  return (
    <main className="about-page">
      <div className="about-header">
        <p className="about-eyebrow">Vitrectomed · Vitrectomy support</p>
        <h1>{t.title}</h1>
      ...
      <section className="about-bottom-note">
        <p>
          ...
          le rôle de Vitrectomed en tant que dispositif d’accompagnement après
