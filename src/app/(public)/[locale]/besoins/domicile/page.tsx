...
export default function MassageBienEtrePage() {
  return (
    <BesoinPageTemplate
      ...
      subtitle="Vitrectomed est conçu exclusivement pour accompagner la convalescence après vitrectomie avec injection de gaz."
      paragraphs={[
        // INTRO
        ...
        // OBJECTIF
        "Vitrectomed a été conçu pour faciliter le maintien de la position prescrite par le chirurgien, tout en améliorant le confort pendant la convalescence.",
        ...
        "Vitrectomed aide à conserver une posture plus stable pendant ces temps de repos, de jour comme de nuit, en s’intégrant dans l’environnement à domicile.",

        // CONFORT & STABILITE
        "Le maintien prolongé de la position post-opératoire peut solliciter fortement la nuque, les épaules et le haut du dos.",
        "Vitrectomed vise à réduire ces contraintes en offrant un appui plus constant et mieux réparti, ce qui peut limiter les tensions liées à la posture.",
        ...
        "Disposer de Vitrectomed avant l’opération peut contribuer à aborder la récupération de façon plus sereine.",

        // IMPORTANT
        "Vitrectomed ne remplace pas un avis médical. La position à respecter, la durée et les consignes associées dépendent de votre situation et doivent être confirmées par votre chirurgien ou votre équipe médicale.",
        ...
        // CONCLUSION
        "Vitrectomed est conçu exclusivement pour accompagner la convalescence après vitrectomie avec injection de gaz, en facilitant le maintien de la position post-opératoire.",
