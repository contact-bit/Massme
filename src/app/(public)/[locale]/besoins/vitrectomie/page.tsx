...
export default function VitrectomiePage() {
  return (
    <BesoinPageTemplate
      title="Vitrectomie"
      subtitle="VitectroMed est un dispositif conçu pour aider au maintien de la position prescrite après une vitrectomie avec injection de gaz."
      paragraphs={[
        // INTRO
        ...
        // SECTION 2 : rôle d’VitectroMed
        "VitectroMed a été conçu pour accompagner les patients durant cette période délicate. Il aide à maintenir la position prescrite plus facilement, tout en améliorant le confort au repos, de jour comme de nuit.",

        // SECTION 3 : usages quotidiens
        "Intégré à l’environnement domestique, VitectroMed permet de conserver une posture plus stable pendant les activités du quotidien compatibles avec la convalescence, tout en respectant les recommandations médicales.",
        ...
        "En facilitant le respect de la position prescrite par le chirurgien, VitectroMed contribue à créer de meilleures conditions pour la phase de récupération après une vitrectomie.",
        ...
        "Est-il possible de dormir après une vitrectomie ? Oui, à condition de respecter la position prescrite. VitectroMed aide à maintenir cette posture plus confortablement.",
        ...
        "VitectroMed est conçu pour accompagner les patients durant la convalescence après vitrectomie, en facilitant le maintien de la position post-opératoire.",
