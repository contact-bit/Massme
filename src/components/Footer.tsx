...
> = {
  ...
  en: {
    ...
    infoLinks: [
      ...
      { label: "Cookies", href: "/cookies" },
      { label: "Terms of sale and use", href: "/cgu" },
    ],
  },
  es: {
    about: "Acerca de",
    ...
    infoLinks: [
      ...
      { label: "Cookies", href: "/cookies" },
      { label: "Condiciones de venta y uso", href: "/cgu" },
    ],
  },
  de: {
    about: "Über uns",
    ...
    infoLinks: [
      ...
      { label: "Cookies", href: "/cookies" },
      { label: "Verkaufs- und Nutzungsbedingungen", href: "/cgu" },
    ],
  },
  it: {
    about: "Chi siamo",
    ...
    infoLinks: [
      ...
      { label: "Condizioni di vendita e utilizzo", href: "/cgu" },
    ],
  },
  nl: {
    about: "Over ons",
    ...
    infoLinks: [
      ...
      { label: "Cookies", href: "/cookies" },
      { label: "Verkoop- en gebruiksvoorwaarden", href: "/cgu" },
    ],
  },
};
